...
export default function ImportFromApps() {
  ...
  const handleFileUpload = async (
    ...
    importType: "goodreads" | "storygraph"
  ) => {
    ...
    formData.append("file", file);
    formData.append("importType", importType);
    formData.append("userId", "placeholder"); // Replace with actual user ID
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold">{t("import_title")}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card bg-base-200">
          <div className="card-body">
            <h3 className="card-title">Goodreads</h3>
            <p>{t("goodreads_description")}</p>
        ...
        <div className="card bg-base-200">
          <div className="card-body">
            <h3 className="card-title">StoryGraph</h3>
            <p>{t("storygraph_description")}</p>
            <div className="card-actions">
              <input
                type="file"
                accept=".csv"
                onChange={(e) => handleFileUpload(e, "storygraph")}
                className="file-input file-input-bordered w-full"
                disabled={importing}
              />
            </div>
