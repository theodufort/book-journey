...
export const WelcomeEmail = () => (
  <div>
    ...
    <p>Hi,</p>
    <p>
      Thank you for signing up for MyBookQuest, the platform that helps you
      build your virtual library and discover new books based on your
    ...
    <p>We’re excited to help you embark on your next literary adventure!</p>
    <p>
      Best regards,
      <br />
      Theo Dufort
